...
let up = `Avishka_X-MD connected successful ✅\n\nPREFIX: ${prefix}`;

conn.sendMessage(ownerNumber + "@s.whatsapp.net", { image: { url: `https://iili.io/2KVSNkv.jpg` }, caption: up })
...
app.get("/", (req, res) => {
res.send("hey,Avishka_X-MD bot started✅");
});
